...
if not os.path.exists('./UpdateLogs.txt'):
    ...
    open('./UpdateLogs.txt', 'w').write(
        "日志创建时间:{}-{}-{} {}:{}".format(lt.tm_year, lt.tm_mon, lt.tm_mday, lt.tm_hour, lt.tm_min) + "\n")
...
if is_old(os.path.getmtime('./UpdateLogs.txt')):
    ...
    with open('./UpdateLogs.txt', 'a') as ulf:
        ...
        ulf.write(
            "  拉取版本推送时间：{}-{}-{} {}:{}".format(lo_push_time.tm_year, lo_push_time.tm_mon, lo_push_time.tm_mday,
